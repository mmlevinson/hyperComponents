...
export const hs = "on click send closeDropdown to #{'click-dropdown-id'} then settle then call alert('You selected ' + my innerHTML)"
...
const hs = "on click send closeDropdown to #{'click-dropdown-id'} then settle then call alert('You selected ' + my innerHTML)"
...
const hs = {
	toggleDropdown: `
		...
		def resetPosition
			...
			set the *left of the #{:dropdownContainer} to (buttonLocation.left + leftOffset + window.pageXOffset) px
			set the *top of the #{:dropdownContainer} to (buttonLocation.bottom  + bottomOffset + window.pageYOffset) px
