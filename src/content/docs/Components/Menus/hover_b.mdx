...
export const hs = "on click send closeDropdown to #{'hover_dropdown_id'} then settle then call alert('You selected ' + my innerHTML) "
...
cexport const hs = "on click send closeDropdown to #{'hover_dropdown_id'} then settle then call alert('You selected ' + my innerHTML) "
