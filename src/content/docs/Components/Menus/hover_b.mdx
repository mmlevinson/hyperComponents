...
-Hyperscript code is located in a separate \<script\> tag with [Behaviors](https://hyperscript.org/docs/#behaviors) installed into elements inside the component
...
Each dropdown component requires a unique id.  This is to ensure that multiple dropdowns do not interact with each other.
