...
This hyperComponent is identical to the previous example Click Activated Dropdown (A) with the differences

##### 1. The dropdown (additonal) appears on hover
...
with the previous example, you can skip to the [Code](#code) section.
