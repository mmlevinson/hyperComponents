...
The first example uses the [ClickDropdownMenu_A](/components/menus/click_a/) parent component to host a custom [PalletGrid](#palletgrid) component.   The code block used to present  this example is listed below.
