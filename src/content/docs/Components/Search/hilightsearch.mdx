...
All routing in Astro is file-based, including backend API routes.    Here is the folder/file structure used for this example
...
The Tab panel below is used to display the entire source code for each backend route.  
