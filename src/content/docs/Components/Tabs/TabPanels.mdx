...
In the example above , a row of classic semi-rounded Tabs is presented above a fixed height container where content is loaded according to the topic displayed in the currently selected Tab.  
...
1. [TabPanel](#tabpanel) component which acts as a parent container, and  
2. Multiple [TabPanelItem](#tabpanelitem) components inserted into the TabPanel default slot. 
