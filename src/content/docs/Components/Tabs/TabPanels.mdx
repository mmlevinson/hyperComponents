...
This example hyperComponent uses [htmx](https://htmx.org) to issue AJAX requests to an [Astro](https://astro.build/docs) API endpoint which returns a [hypermedia](https://htmx.org/essays/hypermedia-apis-vs-data-apis/) response that loads into the container below the tabs.
