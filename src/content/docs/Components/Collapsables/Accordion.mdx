...
A commonly used Web inteface component is an Accordion.   Typically, the Accordion includes a clickable  header which reveals the  body content. The header shows a short string such as a question and the body is initially hidden from view.  Clicking on the header expands the body to reveal the content.  
