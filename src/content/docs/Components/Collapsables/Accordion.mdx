...
A minimal set of default styles are provided but can be overridden or added to by passing additional TW classes to the [styles](#styles) prop.
...
interface Props {
	closeSiblings?:boolean,   //all other Accordions aresent a closeOpenAccordions event
	styles?:string   //override or add TW classes for stying the Group
}
