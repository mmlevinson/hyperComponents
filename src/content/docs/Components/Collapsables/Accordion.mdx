...
<AccordionGroup_A closeSiblings={true} styles='mx-4'>
	<AccordionItem_A id='accordion-htmx'  caption="HTMX" path='/api/readmore/0'/>
	<AccordionItem_A id='accordion-hyperscript'  caption='Hyperscript' path='/api/readmore/1'/>
	<AccordionItem_A id='accordion-tailwind'  caption='Tailwind CSS' path='/api/readmore/2'/>
	<AccordionItem_A id='accordion-astro'  caption='Astro' path='/api/readmore/3' />
</AccordionGroup_A>
