...
This prop takes a string containing any Tailwind classes of your choosing.   These classes will be applied to the `header` when the accordion is open.

Use this prop to override or add styling to the `header` only when it is open.
