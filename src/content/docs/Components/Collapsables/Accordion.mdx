...
A commonly used interface component is an Accordion.     presents a header with tag line and a rotating icon.  Clicking the header exposes additional content with a smooth dropdown like animation.


export const tw = {
	exampleContainer: 'not-content w-full pb-4 w-max-lg text-center mx-auto bg-gray-300 dark:bg-gray-800 rounded-xl my-6',
	exampleTitle: 'bg-gray-300 dark:bg-sky-900 text-gray-300 dark:text-zinc-300 font-semibold py-2 mb-4 rounded-t-xl',
